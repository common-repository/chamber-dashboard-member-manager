		...
		<?php if( $_POST ) { 
			if( ( $_POST['start_date'] == '' ) || ( $_POST['end_date'] == '' ) ) {
				...
				if ( $invoice_query->have_posts() ) { ?>
					<form method='post' action='<?php echo admin_url( 'edit.php?post_type=invoice&page=payment-report'); ?>' id='payment-report'>
						<input type="hidden" name="start_date" id="start_date" value="<?php echo esc_attr($_POST['start_date']); ?>" />
						<input type="hidden" name="end_date" id="end_date" value="<?php echo esc_attr($_POST['end_date']); ?>"  />
